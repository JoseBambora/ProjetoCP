...
\\[\blanklineskip]%
\>[B]{}\Varid{funAux2}\mathbin{::}\Conid{String}\to \mathbb{Z}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{funAux2}\;\text{\ttfamily \char34 \char34}\;\anonymous \mathrel{=}\text{\ttfamily \char34 \char34}{}\<[E]%
\\
\>[B]{}\Varid{funAux2}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{n}\mid \Varid{n}\mathbin{>}\mathrm{0}\mathrel{=}\Varid{funAux2}\;\Varid{t}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{h}\mathbin{:}\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{fun}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{fun}\mathrel{=}\map \;(\map \;(\lambda (\Varid{s},\Varid{n})\to \Varid{funAux2}\;\Varid{s}\;\mathrm{4}))\comp \Varid{foldl}\;\Varid{funAux}\;[\mskip1.5mu \mskip1.5mu]\comp \map \;(\lambda \Varid{s}\to (\Varid{s},\Varid{contaEspacos}\;\Varid{s})){}\<[E]%
\\[\blanklineskip]%
