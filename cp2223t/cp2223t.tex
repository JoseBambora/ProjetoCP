...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 England\char34},\mathrm{4.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\conj{\conj{\Varid{add}\comp (\Varid{add}\times\Varid{id})\comp (((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))}{\p1\comp \p1}}{\p2\comp \p1}{}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outP2}\mathbin{::}[\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Varid{a}+(\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{outP2}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_1\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{outP2}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{h},\Varid{t}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{contaEspacos}\mathbin{::}\Conid{String}\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{contaEspacos}\;\text{\ttfamily \char34 \char34}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{contaEspacos}\;(\text{\ttfamily '~'}\mathbin{:}\Varid{t})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{contaEspacos}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{contaEspacos}\;\anonymous \mathrel{=}\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addLast}\mathbin{::}(\Conid{String},\mathbb{Z})\to [\mskip1.5mu [\mskip1.5mu (\Conid{String},\mathbb{Z})\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu (\Conid{String},\mathbb{Z})\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{addLast}\;\Varid{t}\;\Varid{l}\mathrel{=}(\Varid{take}\;(\length \;\Varid{l}\mathbin{-}\mathrm{1})\;\Varid{l})\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{last}\;(\Varid{l})\mathbin{+\!\!\!+}[\mskip1.5mu \Varid{t}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{funAux}\mathbin{::}[\mskip1.5mu [\mskip1.5mu (\Conid{String},\mathbb{Z})\mskip1.5mu]\mskip1.5mu]\to (\Conid{String},\mathbb{Z}){}\<[53]%
\>[53]{}\to [\mskip1.5mu [\mskip1.5mu (\Conid{String},\mathbb{Z})\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{funAux}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{x}\mathrel{=}[\mskip1.5mu [\mskip1.5mu \Varid{x}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{funAux}\;\Varid{l}\;(\Varid{s},\Varid{n})\mid \p2\;(\Varid{head}\;(\Varid{last}\;(\Varid{l})))\mathbin{<}\Varid{n}\mathrel{=}\Varid{addLast}\;(\Varid{s},\Varid{n})\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
\>[16]{}\mid \Varid{otherwise}\mathrel{=}\Varid{l}\mathbin{+\!\!\!+}[\mskip1.5mu [\mskip1.5mu (\Varid{s},\Varid{n})\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{teste21}\mathrel{=}\Varid{expDepth}\;\Varid{acm\char95 tree}\equiv \mathrm{7}{}\<[E]%
\\
\>[B]{}\Varid{teste22}\mathrel{=}\length \;(\Varid{expOps}\;\Varid{acm\char95 tree})\equiv \mathrm{432}{}\<[E]%
\\
\>[B]{}\Varid{teste23}\mathrel{=}\length \;(\Varid{expLeaves}\;\Varid{acm\char95 tree})\equiv \mathrm{1682}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{fun}\mathbin{::}[\mskip1.5mu \Conid{String}\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{fun}\mathrel{=}\map \;(\map \;(\lambda (\Varid{s},\Varid{n})\to \Varid{drop}\;\mathrm{4}\;\Varid{s}))\comp \Varid{foldl}\;\Varid{funAux}\;[\mskip1.5mu \mskip1.5mu]\comp \map \;(\lambda \Varid{s}\to (\Varid{s},\Varid{contaEspacos}\;\Varid{s})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+(\Varid{id}\times\Varid{fun}))\comp \Varid{outP2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{auxPost}\mathbin{::}(\Conid{String},[\mskip1.5mu [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]\mskip1.5mu])\to [\mskip1.5mu [\mskip1.5mu \Conid{String}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxPost}\;(\Varid{s},\Varid{lis})\mathrel{=}[\mskip1.5mu \Varid{s}\mskip1.5mu]\mathbin{:}(((\map \;(\lambda \Varid{l}\to \Varid{s}\mathbin{:}\Varid{l}))\comp \Varid{concat})\;\Varid{lis}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{post}\mathrel{=}\llparenthesis\, \alt{\Varid{singl}\comp \Varid{singl}}{\Varid{auxPost}}\,\rrparenthesis_\textit{\tiny Exp}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{28}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{geraquadrados}\mathbin{::}\Conid{Square}\to [\mskip1.5mu \Conid{Square}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{geraquadrados}\;((\Varid{x},\Varid{y}),\Varid{c})\mathrel{=}[\mskip1.5mu {}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\Varid{a},\Varid{y}\mathbin{+}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\Varid{a},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x},\Varid{y}\mathbin{+}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a},\Varid{y}\mathbin{+}\Varid{a}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x},\Varid{y}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\Varid{a},\Varid{y}),\Varid{a}),{}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{a},\Varid{y}),\Varid{a})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}{}\<[E]%
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\Varid{a}\mathrel{=}\Varid{c}\mathbin{/}\mathrm{3}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{gsq}\;\Varid{t}\mathrel{=}(\Varid{qc},\map \;(\lambda \Varid{s}\to (\Varid{s},\Varid{paux}))\;\Varid{qv}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{4}{}\<[11]%
\>[11]{}\Varid{paux}\mathrel{=}(\p2\;\Varid{t})\mathbin{-}\mathrm{1}{}\<[E]%
\\
\>[7]{}\hsindent{4}{}\<[11]%
\>[11]{}\Varid{l}\mathrel{=}\Varid{geraquadrados}\;(\p1\;\Varid{t}){}\<[E]%
\\
\>[7]{}\hsindent{4}{}\<[11]%
\>[11]{}\Varid{qc}\mathrel{=}\Varid{head}\;\Varid{l}{}\<[E]%
\\
\>[7]{}\hsindent{4}{}\<[11]%
\>[11]{}\Varid{qv}\mid \Varid{paux}\not\equiv \mathbin{-}\mathrm{1}\mathrel{=}\Varid{tail}\;\Varid{l}{}\<[E]%
\\
\>[11]{}\hsindent{3}{}\<[14]%
\>[14]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{carpets}\;\Varid{n}\mathrel{=}\map \;(\lambda \Varid{s}\to (\Varid{sierpinski}\;(\Varid{squareExemplo},\Varid{s})))\;[\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}\Varid{n}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{squareExemplo}\mathrel{=}((\mathrm{0.0},\mathrm{0.0}),\mathrm{32.0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Square}\mskip1.5mu]\mskip1.5mu]\to \fun{IO}\;[\mskip1.5mu ()\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{present}\mathrel{=}\Varid{sequence}\comp \map \;(\lambda \Varid{l}\to \mathbf{do}\;\{\mskip1.5mu (\Varid{drawSq}\;\Varid{l});\Varid{await};\mskip1.5mu\}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
%podia apresentar um esquema para o carpets e outro para o present nao sei
\subsection*{Problema 4}
\subsubsection*{Versão não probabilística}
O gene de \ensuremath{\Varid{consolidate'}} é:
...
\\
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\Varid{funCgene}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{19}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{funCgene}\mathbin{::}(\Conid{Eq}\;\Varid{a},\Conid{Num}\;\Varid{b})\Rightarrow ((\Varid{a},\Varid{b}),[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu])\to [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{funCgene}\;\Varid{arg}\mathrel{=}\mathbf{case}\;\Varid{lu}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\Conid{Nothing}\to \Varid{cons}\;\Varid{arg}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\Conid{Just}\;\Varid{n}\to (\Varid{cons}\comp ((\Varid{id}\times(\mathbin{+}\Varid{n}))\times(\Varid{filter}\;(\lambda \Varid{tuplo}\to (\p1\;\Varid{tuplo})\not\equiv \Varid{esq}))))\;\Varid{arg}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{lu}\mathrel{=}(\uncurry{(\Varid{\Conid{List}.lookup})}\comp (\p1\times\Varid{id}))\;\Varid{arg}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{esq}\mathrel{=}(\p1\comp \p1)\;\Varid{arg}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pairup}\mathrel{=}(\alt{\Varid{nil}}{\Varid{fun}}\comp \Varid{outList}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{fun}\mathrel{=}\mathsf{conc}\comp \conj{\Varid{fun2}}{\Varid{pairup}\comp \p2}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{fun2}\;(\Varid{x},\Varid{y})\mathrel{=}\map \;(\lambda \Varid{e}\to (\Varid{x},\Varid{e}))\;\Varid{y}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix{
  (A \times A)^* \\
  & &  1 + (A, A^*)\ar[ull]_{\ensuremath{\alt{\Varid{nil}}{\Varid{fun}}}}\\
  A^*\ar[urr]_{\ensuremath{\Varid{outList}}}\ar[uu]^{\ensuremath{\Varid{pairup}}} 
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=1.2cm{
  (A, A^*)\ar[rr]^{\ensuremath{\conj{\Varid{fun2}}{\Varid{pairup}\comp \p2}}} & & (A^*,A^*)\ar[rr]^{\ensuremath{\mathsf{conc}}} & & (A \times A)^*
}
\end{eqnarray*}

A nossa função \ensuremath{\Varid{fun2}} é  muito similar à função zip. A função zip associa elementos de 2 listas, 
originando uma lista com tuplos das respetivas associações. 
A nossa função \ensuremath{\Varid{fun2}} simplesmente um elemento a cada um dos elementos de uma lista, originando 
na mesma tuplos.
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[5]{}\Varid{matchResult}\;\Varid{f}\;\Varid{p}\mathrel{=}[\mskip1.5mu (e_1 ,\Varid{pontos1}),(e_2 ,\Varid{pontos2})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}e_1 \mathrel{=}\p1\;\Varid{p}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}e_2 \mathrel{=}\p2\;\Varid{p}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{result}\mathrel{=}\Varid{f}\;\Varid{p}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{pontos1}\mathrel{=}\Varid{getpontuacao}\;\Varid{result}\;e_1 {}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{pontos2}\mathrel{=}\Varid{getpontuacao}\;\Varid{result}\;e_2 {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{matchResult}\;\Varid{f}\mathrel{=}\Varid{getPointsMatch}\comp \conj{\Varid{id}}{\Varid{f}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getpontuacao}\mathbin{::}(\Conid{Team},\Conid{Maybe}\;\Conid{Team})\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{getpontuacao}\;(\Varid{e},\Varid{r})\mathrel{=}\mathbf{case}\;\Varid{r}\;\mathbf{of}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Conid{Nothing}\to \mathrm{1}{}\<[E]%
\\
\>[B]{}\hsindent{23}{}\<[23]%
\>[23]{}\Conid{Just}\;\Varid{t}\to \mathbf{if}\;\Varid{t}\equiv \Varid{e}\;\mathbf{then}\;\mathrm{3}{}\<[E]%
\\
\>[23]{}\hsindent{10}{}\<[33]%
\>[33]{}\mathbf{else}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getPointsMatch}\mathbin{::}(\Conid{Match},\Conid{Maybe}\;\Conid{Team})\to [\mskip1.5mu (\Conid{Team},\mathbb{Z})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getPointsMatch}\mathrel{=}\mathsf{conc}\comp (\Varid{fmr}\times\Varid{fmr})\comp \conj{\p1\times\Varid{id}}{\p2\times\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{fmr}\mathrel{=}\Varid{singl}\comp \conj{\p1}{\Varid{getpontuacao}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix{
  (E \times \ensuremath{\N_0})^* & & (E \times \ensuremath{\N_0})^* \times (E \times \ensuremath{\N_0})\ar[ll]^{\ensuremath{\uncurry{(\mathbin{+\!\!\!+})}}}\\
  & & & & ((E \times R) \times (E \times R))\ar[ull]_{\ensuremath{\Varid{fmr}\times\Varid{fmr}}}\\
  (f \ (E \times E))\ar[rr]^{\ensuremath{\conj{\Varid{id}}{\Varid{f}}}}\ar[uu]^{\ensuremath{\Varid{matchResult}}} & & ((E \times E) \times R)\ar[urr]^{\ensuremath{\conj{\p1\times\Varid{id}}{\p2\times\Varid{id}}}}\ar[uu]^{\ensuremath{\Varid{getPointsMatch}}}\\
}
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix{
  (E \times R)\ar[rr]^{\ensuremath{\conj{\p1}{\Varid{getpontuacao}}}} & & (E \times \ensuremath{\N_0})\ar[rr]^{\ensuremath{\Varid{singl}}} & & (E,Nat)^* 
}
\end{eqnarray*}
...
\begin{eqnarray}
\xymatrix{
  A^*\ar[rr]^{\ensuremath{\Varid{glt}}} & & A + (A^* \times A^*)
}
\end{eqnarray}

A nossa função glt, quando recebe uma lista com apenas um único elemento, injeta esse mesmo
elemento à esquerda numa alternativa. Caso contrário, invoca a função \ensuremath{\Varid{splitAt}} do prelude do 
...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{glt}\mathrel{=}(\Varid{id}+(\uncurry{\Varid{splitAt}}\comp \conj{\Varid{metade}\comp \length }{\Varid{id}}\comp \Varid{cons}))\comp \Varid{outP2}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\Varid{metade}\;\Varid{n}\mathrel{=}\Varid{n}\div \mathrm{2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{pinitKnockoutStage}\mathrel{=}\llparenthesis\, \alt{\Varid{createDist}}{\Varid{tupleDist}}\,\rrparenthesis\comp \Varid{initKnockoutStage}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{createDist}\;\Varid{t}\mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{t},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{tupleDist}\mathrel{=}\uncurry{(\Varid{joinWith}\;\overline{\Conid{Fork}})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray}
\xymatrix{
  Dist (LTree Team)                                                                 & & Team + (Dist\ (LTree\ Team) \times Dist\ (LTree\ Team))\ar[ll]_(0.65){\ensuremath{\alt{\Varid{createDist}}{\Varid{tupleDist}}}}\\
  LTree Team \ar[u]^{\ensuremath{\llparenthesis\, \alt{\Varid{createDist}}{\Varid{tupleDist}}\,\rrparenthesis}}\ar[rr]_(0.35){\ensuremath{\mathsf{out}_{\tiny\ \textit{LTree}}}} & & Team + (LTree\ Team \times LTree\ Team) \ar[u]_{\ensuremath{\Varid{id}\mathbin{+}\Varid{pgroupWinners}\times\Varid{pgroupWinners}}}\\
  (Team^*)^*\ar[u]^{\ensuremath{\Varid{initKnockoutStage}}}
}
\end{eqnarray}
...
\\
\>[B]{}\Varid{pgroupWinners}\;\Varid{f}\mathrel{=}\Varid{pmatchResult}\comp \conj{\Varid{sequence}\comp \map \;(\lambda \Varid{m}\to (\Varid{f}\;\Varid{m}))}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{14}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getPoints}\mathbin{::}([\mskip1.5mu \Conid{Match}\mskip1.5mu],[\mskip1.5mu \Conid{Maybe}\;\Conid{Team}\mskip1.5mu])\to [\mskip1.5mu (\Conid{Team},\mathbb{Z})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getPoints}\mathrel{=}{}\<[14]%
\>[14]{}\llparenthesis\, \alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{getPointsMatch}\times\Varid{id})}\,\rrparenthesis\comp \uncurry{\Varid{zip}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pmatchResult}\mathbin{::}(\fun{Dist}\;[\mskip1.5mu \Conid{Maybe}\;\Conid{Team}\mskip1.5mu],[\mskip1.5mu \Conid{Match}\mskip1.5mu])\to \fun{Dist}\;[\mskip1.5mu \Conid{Team}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{pmatchResult}\;(\Varid{resultados},\Varid{partidas})\mathrel{=}\Varid{mapD}\;(\Varid{best}\;\mathrm{2}\comp \Varid{consolidate}\comp \Varid{getPoints}\comp \conj{\underline{\Varid{partidas}}}{\Varid{id}})\;\Varid{resultados}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Argentina\char34},\mathrm{4.4}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Australia\char34},\mathrm{4.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Belgium\char34},\mathrm{4.2}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Brazil\char34},\mathrm{4.7}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Cameroon\char34},\mathrm{4.0}),{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Croatia\char34},\mathrm{4.7}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Denmark\char34},\mathrm{4.3}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Ecuador\char34},\mathrm{4.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 England\char34},\mathrm{3.8}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 France\char34},\mathrm{5.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Germany\char34},\mathrm{5.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Ghana\char34},\mathrm{3.9}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Iran\char34},\mathrm{4.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Japan\char34},\mathrm{4.1}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Korea~Republic\char34},\mathrm{3.9}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Mexico\char34},\mathrm{4.5}),{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Netherlands\char34},\mathrm{4.8}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Poland\char34},\mathrm{4.2}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Portugal\char34},\mathrm{5.5}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Qatar\char34},\mathrm{3.9}),{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Serbia\char34},\mathrm{3.8}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Spain\char34},\mathrm{4.0}),{}\<[E]%
\\
\>[B]{}\hsindent{10}{}\<[10]%
\>[10]{}(\text{\ttfamily \char34 Switzerland\char34},\mathrm{4.4}),{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{*}\Conid{Main}\mathbin{>}\Varid{winner}{}\<[E]%
\\
\>[B]{}\text{\ttfamily \char34 Portugal\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbin{*}\Conid{Main}\mathbin{>}\Varid{pwinner}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\text{\ttfamily \char34 Portugal\char34}\;{}\<[16]%
\>[16]{}\mathrm{33.7}\mathbin{\%}{}\<[E]%
\\
\>[4]{}\hsindent{2}{}\<[6]%
\>[6]{}\text{\ttfamily \char34 France\char34}\;{}\<[16]%
\>[16]{}\mathrm{14.7}\mathbin{\%}{}\<[E]%
\\
\>[4]{}\hsindent{1}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Germany\char34}\;{}\<[16]%
\>[16]{}\mathrm{14.0}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\text{\ttfamily \char34 Netherlands\char34}\;{}\<[17]%
\>[17]{}\mathrm{8.8}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Croatia\char34}\;{}\<[17]%
\>[17]{}\mathrm{5.6}\mathbin{\%}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\text{\ttfamily \char34 Mexico\char34}\;{}\<[17]%
\>[17]{}\mathrm{3.8}\mathbin{\%}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\text{\ttfamily \char34 Brazil\char34}\;{}\<[17]%
\>[17]{}\mathrm{3.8}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Uruguay\char34}\;{}\<[17]%
\>[17]{}\mathrm{2.8}\mathbin{\%}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\text{\ttfamily \char34 USA\char34}\;{}\<[17]%
\>[17]{}\mathrm{2.7}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Senegal\char34}\;{}\<[17]%
\>[17]{}\mathrm{2.0}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\text{\ttfamily \char34 Switzerland\char34}\;{}\<[17]%
\>[17]{}\mathrm{1.8}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\text{\ttfamily \char34 Argentina\char34}\;{}\<[17]%
\>[17]{}\mathrm{1.6}\mathbin{\%}{}\<[E]%
\\
\>[3]{}\hsindent{4}{}\<[7]%
\>[7]{}\text{\ttfamily \char34 Wales\char34}\;{}\<[17]%
\>[17]{}\mathrm{1.6}\mathbin{\%}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Denmark\char34}\;{}\<[17]%
\>[17]{}\mathrm{1.2}\mathbin{\%}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Morocco\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.7}\mathbin{\%}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\text{\ttfamily \char34 Tunisia\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.3}\mathbin{\%}{}\<[E]%
\\
\>[5]{}\hsindent{1}{}\<[6]%
\>[6]{}\text{\ttfamily \char34 Poland\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.3}\mathbin{\%}{}\<[E]%
\\
\>[6]{}\hsindent{1}{}\<[7]%
\>[7]{}\text{\ttfamily \char34 Spain\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.2}\mathbin{\%}{}\<[E]%
\\
\>[6]{}\hsindent{1}{}\<[7]%
\>[7]{}\text{\ttfamily \char34 Japan\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.1}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\text{\ttfamily \char34 Costa~Rica\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.1}\mathbin{\%}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\text{\ttfamily \char34 Canada\char34}\;{}\<[17]%
\>[17]{}\mathrm{0.1}\mathbin{\%}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
